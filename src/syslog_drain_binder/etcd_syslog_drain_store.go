...
func (store *EtcdSyslogDrainStore) UpdateDrains(appDrainUrlMap map[string][]string) error {
...
func (store *EtcdSyslogDrainStore) updateAppDrains(appId string, drainUrls []string) error {
